    ...
    <div class="min-h-[calc(100vh-8rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-gray-100">
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">Masuk ke akun TechHire Anda</p>
            </div>
            <a href="{{ route('auth.social.redirect', 'google') }}"
               class="mt-8 w-full inline-flex items-center justify-center gap-3 py-3 px-4 border-2 border-gray-300 rounded-xl text-sm font-bold text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 transition shadow-sm">
